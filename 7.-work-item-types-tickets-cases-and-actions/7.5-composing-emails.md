...
{% hint style="info" %}
_Note: You can write an email without needing to have the work item assigned to you._
{% endhint %}
...
{% hint style="info" %}
_Note: Any files linked to the canned text section will also be attached at the same time._
{% endhint %}
...
{% hint style="info" %}
_Note: The system will show the canned text in your language by default._
{% endhint %}
